...
const Tour = () => {
  return (
    <div className={globalStyles.html}>
      <Head>
        <title>Eternal Ghosts tour</title>
      </Head>
      ...
      <main>
        <header className={globalStyles.header}>
          <nav>
            ...
            <Link href="/tour" className={clsx(globalStyles.siteTitle, globalStyles.active)}>TOUR</Link>
        ...
        <p className={tourStyles.navPageTitle}>TOUR</p>
          <div>
            <Link href='https://www.facebook.com/profile.php?id=61573032031881'>
              <Image src="/pictures/facebook-icon.png" alt="Eternal Ghosts Facebook" className={tourStyles.facebookIcon} width={94.1084} height={94.1083}/>
            </Link>
          </div>
          <div>
            <Link href="https://www.youtube.com/watch?v=B_YRm7NKeas" >
              <Image src="/pictures/youtube-icon.png"  className={tourStyles.youtubeIcon} alt="Eternal Ghosts Youtube" width={94.1084} height={94.1083}/>
            </Link>
          </div>
          <div>
            <Link href="https://www.instagram.com/eternalghosts0/">
              <Image src="/pictures/instagram-icon.png" className={tourStyles.instagramIcon} alt="Eternal Ghosts Instagram" width={94.1084} height={94.1083}/>
            </Link>
          </div>
        </div>
      </section>
